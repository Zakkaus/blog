...
**上一步**：[桌面配置](/zh-cn/posts/gentoo-install-desktop/)
...
**官方文档**：[make.conf - Gentoo Wiki](https://wiki.gentoo.org/wiki//etc/portage/make.conf) · [基础篇 5.2 节：make.conf 范例](/zh-cn/posts/gentoo-install/#52-makeconf-范例)
...
**快速上手**：请参考 [基础篇 5.3 节：CPU 指令集优化](/zh-cn/posts/gentoo-install/#53-配置-cpu-指令集优化)
...
推荐使用 `/etc/portage/package.use/` 方式针对特定软件包配置，详见 [桌面配置篇 12.1 节](/zh-cn/posts/gentoo-install-desktop/#121-全局配置)。
...
4. **VIDEO_CARDS / INPUT_DEVICES** 已移至 [桌面配置篇](/zh-cn/posts/gentoo-install-desktop/)
...
- **快速设置步骤**：请直接按照基础篇 [5.3 配置 CPU 指令集优化](/zh-cn/posts/gentoo-install/#53-配置-cpu-指令集优化) 完成。
...
- [桌面配置篇 12.1 节：VIDEO_CARDS 配置](/zh-cn/posts/gentoo-install-desktop/#121-全局配置)
