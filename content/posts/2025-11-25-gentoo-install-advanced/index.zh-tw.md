...
aliases:
  - /zh-tw/posts/gentoo-optimization/
...
**系列導航**：
1. [基礎安裝](/zh-tw/posts/gentoo-install/)：從零開始安裝 Gentoo 基礎系統
2. [桌面設定](/zh-tw/posts/gentoo-install-desktop/)：顯示卡驅動程式、桌面環境、輸入法等
3. **進階優化（本文）**：make.conf 優化、LTO、系統維護

**上一步**：[桌面設定](/zh-tw/posts/gentoo-install-desktop/)
...
**官方文件**：[make.conf - Gentoo Wiki](https://wiki.gentoo.org/wiki//etc/portage/make.conf) · [基礎篇 5.2 節：make.conf 範例](/zh-tw/posts/gentoo-install/#52-makeconf-範例)
...
**快速上手**：請參考 [基礎篇 5.3 節：CPU 指令集優化](/zh-tw/posts/gentoo-install/#53-設定-cpu-指令集優化)
...
推薦使用 `/etc/portage/package.use/` 方式針對特定軟體套件設定，詳見 [桌面設定篇 12.1 節](/zh-tw/posts/gentoo-install-desktop/#121-全局設定)。
...
4. **VIDEO_CARDS / INPUT_DEVICES** 已移至 [桌面設定篇](/zh-tw/posts/gentoo-install-desktop/)
...
- **快速設定步驟**：請直接按照基礎篇 [5.3 設定 CPU 指令集優化](/zh-tw/posts/gentoo-install/#53-設定-cpu-指令集優化) 完成。
...
- [桌面設定篇 12.1 節：VIDEO_CARDS 設定](/zh-tw/posts/gentoo-install-desktop/#121-全局設定)
