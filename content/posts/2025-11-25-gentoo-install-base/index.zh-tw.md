...
> 2. [桌面配置](/zh-tw/posts/gentoo-install-desktop/)：顯示卡驅動、桌面環境、輸入法等
...
> **進階內容**：如果你想深入了解核心配置、使用 LLVM/Clang 編譯核心、啟用 LTO 最佳化等進階選項，請參考 **[Section 16.0 核心編譯進階指南](/zh-tw/posts/gentoo-install-advanced/#section-16-kernel-advanced)**。
...
>
> **下一步**：[桌面配置](/zh-tw/posts/gentoo-install-desktop/)
