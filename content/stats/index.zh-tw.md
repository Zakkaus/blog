...
---
{{< lead >}}
這裡即時呈現 zakk.au 的全站流量：所有資料都由 Cloudflare Stats Worker 驅動，透過 Cloudflare Workers、KV 與 D1 無 Cookie 計算並更新。{{< /lead >}}
...
{{< statsTop title="熱門頁面 Top 10" ctaLabel="在 stats.zakk.au 查看更多" ctaUrl="https://stats.zakk.au/" emptyText="目前沒有資料" errorText="暫時無法載入熱門頁面" >}}
