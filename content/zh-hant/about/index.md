...
{{< lead >}}
嗨，我是 **Zakk**。住在澳洲雪梨的商科學生，會用雙語寫 Gentoo / Linux 筆記、設計小實驗、理財心得，以及和 Paper 還有兩隻天竺鼠的生活記事。
{{< /lead >}}

{{< alert icon="heart" >}}
我和 Paper 從 **2025 年 8 月 7 日** 開始遠距（澳洲－台灣），我們都是泛性戀 🩷💛🩵，會一起分享每日行程、音樂歌單、設計靈感，也在 [時間軸](/zh-hant/timeline/#couple) 上記錄相處的天數。
{{< /alert >}}

### 摘要
- 📍 雪梨生活，時區在 AEST / AEDT，主修商業。
- 🧠 興趣：Gentoo、Linux、氛圍音樂、設計系統、理財與整理生活。
- 🎮 日常娛樂：和 Paper 一起語音、畫畫、打電動、研究設備。
- 🐹 家裡成員：Potato 與 Hash Brown 兩隻 Teddy 天竺鼠。

### 我和 Paper
我們是在 [Ceylan](https://www.youtube.com/@xilanceylan) 的 Discord 認識，一開始只是聊天分享生活，後來變成每天互相陪伴、同步彼此日程的默契伙伴。我們每隔幾個月會安排見面，Paper 目前在台灣念高三，之後會來澳洲念書。想看我們的日常可以追蹤 Paper 的 IG：[ @abyss_74.50 ](https://www.instagram.com/abyss_74.50/)，也可以到 [時間軸](/zh-hant/timeline/#couple) 看實際天數。

### 天竺鼠
#### Hash Brown（2025/06/24） {#hash-brown}
- 淺棕色 Teddy，活力滿點，最愛在籠子裡衝刺、搬移小屋。
- 看到人或冰箱就會用中文的「515151」聲音討食。
- 最愛：紅／綠甜椒、玉米鬚、紅蘿蔔。
- 更多照片會放在 [Instagram @zakk.au](https://www.instagram.com/zakk.au/)。

#### Potato（2025/07/27） {#potato}
- 深棕色 Teddy，超愛吃又很勇敢，偶爾邊吃邊便便。
- 很會把自己埋在牧草裡睡覺，醒來繼續吃。
- 最愛：甜椒、玉米鬚、紅蘿蔔。
- [時間軸](/zh-hant/timeline/#potato) 上可以看到她的天數，也會在 IG 限動出現。
